...
2. **导航到脚本所在文件夹**
   ...
   - 例如：`E:\AgentRules\English\rules-2.3.3-optimized\mcp-scripts`
   - 按回车键进入该文件夹
...
powershell -ExecutionPolicy Bypass -File "E:\AgentRules\English\rules-2.3.3-optimized\mcp-scripts\install-mcp-tools-enhanced-final.ps1"
```
