...
- [ ] **规则文件**：已下载 `rules-2.1-optimized-2.2.1` 文件夹
- [ ] **项目目录**：已有项目文件夹或准备创建一个

### 📚 文件准备
1. 将 `rules-2.1-optimized-2.2.1` 文件夹放在易于访问的位置（如桌面）
...
cd "你的rules-2.1-optimized-2.2.1目录路径"  # 步骤2：切换到具体目录
```
...
cd D:\你的rules-2.1-optimized-2.2.1目录路径  # 直接切换到目标目录
```
...
```
cd c:\Users\luo20\Desktop\rules-2.1-optimized-2.2.1
```
