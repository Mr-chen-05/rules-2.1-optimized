...
|------|------------|------------|----------|
| `frontend` | 44 个.mdc文件 | P0-P7 (8层) | React、Vue、Angular 项目 |
| `backend` | 43 个.mdc文件 | P0-P7 (8层) | API、服务器、数据库项目 |
| `fullstack` | 45 个.mdc文件 | P0-P7 (8层) | 完整的 Web 应用程序（推荐） |
...
| ------------- | --------------- | ------------ | -------------------------------------------------- |
| **Frontend**  | 44 个.mdc文件   | 约8-15个     | 前端规则 + mermaid 图表支持 + 核心安全规则         |
| **Backend**   | 43 个.mdc文件   | 约8-15个     | 后端规则（不含 mermaid）+ 核心安全规则             |
| **Fullstack** | 45 个.mdc文件   | 约8-15个     | 前端 + 后端完整规则 + 核心安全规则                 |
...
- `frontend` - 前端开发（44 个.mdc文件，P0-P7 优先级层次）
- `backend` - 后端开发（43 个.mdc文件，P0-P7 优先级层次）
- `fullstack` - 全栈开发（45 个.mdc文件，P0-P7 优先级层次，推荐）
...
2. **文件计数**: 确保所有 45 个.mdc文件都存在（全栈模式）
