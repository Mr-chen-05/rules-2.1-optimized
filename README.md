...
```powershell
# 进入规则目录
cd "你的rules-2.4.2-optimized目录路径"
...
| `/api-design` | API设计 | 接口设计和文档 | `api-design.mdc` |
| `/database-design` | 数据库设计 | 数据模型设计 | `database-design.mdc` |
| `/responsive-design` | 响应式设计 | 移动端适配 | `responsive-design.mdc` |
...
### 🚀 **AI智能核心系统**
- **文件**: `ai-agent-intelligence-core.md`
- **功能**: AI助手智能核心，提供基础智能能力
- **特点**: 自动激活，增强AI理解和决策能力

### 🔄 **完整工作流集成**
- **文件**: `complete-workflow-integration.mdc`
- **功能**: 集成所有开发工作流程，无缝衔接
- **特点**: 自动化流程管理，提升开发效率
